...
class FunctionController {
    ...
    FunctionController(ChatClient.Builder chatClientBuilder) {
        this.chatClient = chatClientBuilder.clone()
                .defaultAdvisors(new SimpleLoggerAdvisor())
                .build();
    }

    @PostMapping("/chat/function/raw")
    String chatFunctionRaw(@RequestBody String userPrompt) {
        return chatClient.prompt()
                .user(userPrompt)
                .toolNames(Functions.WELCOME, Functions.WELCOME_USER, Functions.BOOKS_BY_AUTHOR, Functions.AUTHORS_BY_BOOKS)
                .call()
                .content();
    }
