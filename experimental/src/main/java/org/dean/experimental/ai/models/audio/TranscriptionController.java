package org.dean.experimental.ai.models.audio;
...
class TranscriptionController {
    ...
    String speech(@Value("classpath:audio/speech1.mp3") Resource audioFile) {
    ...
    String speechProviderOptions(@Value("classpath:audio/speech2.mp3") Resource audioFile) {
