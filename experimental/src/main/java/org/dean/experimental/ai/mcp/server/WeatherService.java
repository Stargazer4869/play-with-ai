package org.dean.experimental.ai.mcp.server;
...
//
//        // 0% progress
//        exchange.progressNotification(new McpSchema.ProgressNotification(progressToken, 0.0, 1.0, "Retrieving weather forecast"));
//
